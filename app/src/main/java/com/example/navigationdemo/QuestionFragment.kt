...
class QuestionFragment : Fragment() {
    ...
    private val questions: MutableList<Question> = mutableListOf(
        Question(
            ...
            answer = listOf("Movement Control Order", "Multiple Choice Order", "More Coffee Order " )
        ),
        Question(
            text = "What is FMCO?",
            answer = listOf("Full Movement Control Oder",  "Fun Movement Control Oder", "Forever Movement Control Oder")
        )
    )
        ...
        binding.btnNext.setOnClickListener(){
            ...
            if (checkedId != -1) {
                ...
                if (questionIndex < 1) {
                    ...
                    Navigation.findNavController(it).navigate(R.id.action_questionFragment_to_thankyouFragment2)
                }
            }else{
